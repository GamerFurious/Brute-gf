    ...
    def info(self):
        ...
        while self.on:
            ...
            if size != 0:
                ...
                print(stage(f"{fluo}{round(size)} {white}Mb/s {blue}-{white} Total: {fluo}{round(self.total, 1)} {white}Gb. {' '*20}"), end='\r')
...
bblue = Col.StaticMIX((Col.blue, Col.black, blue))
blue = Col.StaticMIX((Col.blue, blue, Col.white))
...
def main():
    print()
    print(Colorate.Diagonal(Col.DynamicMIX((Col.white, bblue)), Center.XCenter(banner)))


    ip = input(stage(f"Enter the IP to Brute {blue}->{fluo2} ", '?'))
    print()
    ...
    port = input(stage(f"Enter port {blue}[{white}press {fluo2}enter{white} to attack all ports{blue}] {blue}->{fluo2} ", '?'))
    print()
    ...
    force = input(stage(f"Bytes per packet {blue}[{white}press {fluo2}enter{white} for 1250{blue}] {blue}->{fluo2} ", '?'))
    print()
    ...
    threads = input(stage(f"Threads {blue}[{white}press {fluo2}enter{white} for 100{blue}] {blue}->{fluo2} ", '?'))
    print()
    ...
    print()
    cport = '' if port is None else f'{blue}:{fluo2}{port}'
    ...
    try:
        ...
        brute.stop()
        print(stage(f"Attack stopped. {fluo2}{ip}{cport}{white} was Brute with {fluo}{round(brute.total, 1)} {white}Gb.", '.'))
    print('\n')
    sleep(1)
